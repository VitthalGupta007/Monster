    ...
    public static class EasingFunctions
    {
        ...
        static EasingFunctions()
        {
            Functions = new FunctionPointer<EasingFunction>[]
            {
                ...
                BurstCompiler.CompileFunctionPointer<EasingFunction>(QuadIn),
                BurstCompiler.CompileFunctionPointer<EasingFunction>(QuadOut),
                BurstCompiler.CompileFunctionPointer<EasingFunction>(QuadOutIn),

                BurstCompiler.CompileFunctionPointer<EasingFunction>(CubicIn),
                BurstCompiler.CompileFunctionPointer<EasingFunction>(CubicOut),
                BurstCompiler.CompileFunctionPointer<EasingFunction>(CubicInOut),

                BurstCompiler.CompileFunctionPointer<EasingFunction>(QuartIn),
                BurstCompiler.CompileFunctionPointer<EasingFunction>(QuartOut),
                BurstCompiler.CompileFunctionPointer<EasingFunction>(QuartInOut),

                BurstCompiler.CompileFunctionPointer<EasingFunction>(QuintIn),
                BurstCompiler.CompileFunctionPointer<EasingFunction>(QuintOut),
                BurstCompiler.CompileFunctionPointer<EasingFunction>(QuintInOut),

                BurstCompiler.CompileFunctionPointer<EasingFunction>(SineIn),
                BurstCompiler.CompileFunctionPointer<EasingFunction>(SineOut),
                BurstCompiler.CompileFunctionPointer<EasingFunction>(SineInOut),

                BurstCompiler.CompileFunctionPointer<EasingFunction>(CircIn),
                BurstCompiler.CompileFunctionPointer<EasingFunction>(CircOut),
                BurstCompiler.CompileFunctionPointer<EasingFunction>(CircInOut),

                BurstCompiler.CompileFunctionPointer<EasingFunction>(ExpoIn),
                BurstCompiler.CompileFunctionPointer<EasingFunction>(ExpoOut),
                BurstCompiler.CompileFunctionPointer<EasingFunction>(ExpoInOut),

                BurstCompiler.CompileFunctionPointer<EasingFunction>(ElasticIn),
                BurstCompiler.CompileFunctionPointer<EasingFunction>(ElasticOut),
                BurstCompiler.CompileFunctionPointer<EasingFunction>(ElasticInOut),

                BurstCompiler.CompileFunctionPointer<EasingFunction>(BackIn),
                BurstCompiler.CompileFunctionPointer<EasingFunction>(BackOut),
                BurstCompiler.CompileFunctionPointer<EasingFunction>(BackInOut),

                BurstCompiler.CompileFunctionPointer<EasingFunction>(BounceIn),
        ...
        {
            return math.abs(a - b) < 1e-5f; // same default epsilon as Mathf.Approximately
        }
    }
}